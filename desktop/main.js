  ...
  const template = [
    ...
    },
    {
      ...
      submenu: [
        ...
        {
          label: '📱 Tải bản Android APK v1.4.0',
        ...
        { type: 'separator' },
        {
          label: 'Về ứng dụng Smart Teacher Schedule AI v1.4.0',
          click: () => {
            if (Notification.isSupported()) {
              new Notification({
                title: 'Smart Teacher Schedule AI Desktop',
                body: 'Phiên bản v1.4.0 - Hệ sinh thái đồng bộ đám mây đa nền tảng cho giáo viên.'
              }).show();
            }
          }
        }
