...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Smart Teacher Schedule AI - Trợ lý Sư Phạm & Lịch Dạy Giáo Viên v2.0.0",
    description:
      "Tải app v2.0.0 chính thức: Hệ sinh thái Đa Nền Tảng (Android, Web, Desktop), Sổ điểm & Học bạ điện tử Thông tư 22, Trợ lý AI Soạn bài CV 5512, Đề thi Ma trận đặc tả, Voice AI Tutor và Bản quyền Huy Technology AI.",
    images: [
      {
