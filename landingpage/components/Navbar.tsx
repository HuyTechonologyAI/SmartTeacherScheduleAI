      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden sm:flex items-center space-x-3">
            ...
            <a
              href="https://github.com/HuyTechonologyAI/SmartTeacherScheduleAI/releases/download/v1.3.3/SmartTeacherSchedule_v1.3.3_Release.apk"
      ...
      {mobileMenuOpen && (
        <div className="md:hidden glass-panel border-t border-white/10 px-4 pt-3 pb-6 space-y-3">
          ...
          <div className="pt-2 space-y-2">
            ...
            >
              <Download className="w-4 h-4" />
              <span>Tải APK Miễn Phí (v1.3.3)</span>
            </a>
          </div>
        </div>
      )}
